  ...
  return (
    <div className="fixed w-full h-full bg-black bg-opacity-60 top-0 left-0 grid place-items-center">
      <motion.form
        ...
        className="w-1/2 bg-primary-400 border-2 border-primary-600 rounded-lg flex flex-col items-center p-4 gap-4"
      >
        ...
        <textarea
          ...
          className={classNames(
            "m-h-1/2 w-5/6 bg-primary-300 text-2xl rounded-sm shadow-md border-primary-600 focus:shadow-md focus:outline-1 focus:outline-primary-600 p-4 break-all resize-none",
            {
